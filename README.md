...
* UI Design para Iniciantes ![](https://geps.dev/progress/67)

| Curso | Status|
|---|---|
|01 UI Design Para Iniciantes|✔️|
|02 Ferramenta|✔️|
|03 UI Design|✔️|
...
* HTML e CSS para Iniciantes ![](https://geps.dev/progress/43)

| Curso | Status   |
|---|---|
|01 HTML e CSS para Iniciantes|✔️|
|02 HTML e CSS Básico|✔️|
|03 CSS Posicionamento|✔️|
|04 HTML e Semântica|✔️|
|05 CSS Propriedades|✔️|
|06 Responsivo||
...
* CSS Flexbox ![](https://geps.dev/progress/0)
...
* React ![](https://geps.dev/progress/0)
...
* WordPress REST API Dogs ![](https://geps.dev/progress/0)

| Curso | Status   |
|---|---|
|01 WordPress REST API Dogs   |   |

![image](https://user-images.githubusercontent.com/102985050/217962630-d858252c-5563-42c8-9563-21eeaeef0a27.png)
* Typescript ![](https://geps.dev/progress/0)

| Curso | Status   |
|---|---|
|01 TypeScript para Iniciantes   |   |
|02 TypeScript Básico   |   |
|03 Objetos e Interfaces   |   |
|04 Mais TypeScript   |   |
|05 Desenvolvimento   |   |
|06 Prática Dados   |   |
|07 Prática DOM   |   |
|08 Considerações Finais   |   |

![image](https://user-images.githubusercontent.com/102985050/217962637-f76f7653-c567-4aac-ae6d-4541ee5c8a07.png)
* Redux ![](https://geps.dev/progress/0)
...
* WordPress como CMS ![](https://geps.dev/progress/0)
...
* UX Design Heurísticas ![](https://geps.dev/progress/0)

| Curso | Status   |
|---|---|
|01 UX Design - Heurísticas|   |
|02 Consciência de Mundo|   |
|03 Heurísticas de Nielsen|   |
|04 UI com UX|   |
|05 Psicologia para Designers|   |
...
* Adobe XD ![](https://geps.dev/progress/0)

| Curso | Status   |
|---|---|
|01 Adobe XD|   |
|02 Fundamentos Adobe XD|   |
|03 Protótipo com Adobe XD|   |
|04 Mais Adobe XD|   |
|05 Considerações Finais|   |

![image](https://user-images.githubusercontent.com/102985050/217962854-916d195a-d4e4-412f-976e-c1070d769764.png)
* Vue.js 2 Completo ![](https://geps.dev/progress/0)

| Curso | Status   |
|---|---|
|01 Vue.js Completo|   |
|02 Vue.js Para Iniciantes|   |
|03 Diretivas e Hooks|   |
|04 Techno Projeto|   |
|05 Componentes|   |
|06 Animacoes|   |
|07 Vue Router|   |
...
* WordPress Rest API ![](https://geps.dev/progress/0)

| Curso | Status   |
|---|---|
|01 WordPress REST API|   |

![image](https://user-images.githubusercontent.com/102985050/217962890-508e0b57-0005-4570-9813-25378223fd3b.png)
* WooCommerce Como CMS ![](https://geps.dev/progress/0)

| Curso | Status   |
|---|---|
|01 WooCommerce Como CMS|   |
|02 PHP Básico|   |
|03 Tema WordPress|   |
|04 WooCommerce Projeto|   |
|05 WooCommerce Estilo|   |
|06 Considerações Finais|   |

![image](https://user-images.githubusercontent.com/102985050/217962900-33a55e96-ab2b-4731-902f-b4e1fa001413.png)
* Bootstrap 4 ![](https://geps.dev/progress/0)

| Curso | Status   |
|---|---|
|01 Bootstrap 4|   |
|02 Introdução ao Bootstrap 4|   |
|03 Fundamentos do Bootstrap 4|   |
|04 Mais Bootstrap 4|   |
|05 Considerações Finais|   |

![image](https://user-images.githubusercontent.com/102985050/217962908-78507330-aeaf-4fa5-8e5f-81357757486b.png)
* Automação Frond End com NPM ![](https://geps.dev/progress/0)

| Curso | Status   |
|---|---|
|01 Automação Front End com NPM|   |
|02 Introdução ao NPM|   |
|03 Automação com Gulp|   |
|04 Outras Automações|   |
|05 Considerações Finais|   |

![image](https://user-images.githubusercontent.com/102985050/217962913-f584ade5-4865-4c9b-b06b-717913045695.png)
* JavaScript e jQuery ![](https://geps.dev/progress/0)

| Curso | Status   |
|---|---|
|01 JavaScript e jQuery|   |
|02 Fundamentos do JavaScript|   |
|03 jQuery|   |
|04 Prática com jQuery|   |
|05 Mais JS e jQuery|   |
|06 Considerações Finais|   |

![image](https://user-images.githubusercontent.com/102985050/217962926-1368b6e1-4458-48ce-87b7-1fade16a78ef.png)
* Web Design Completo ![](https://geps.dev/progress/0)
